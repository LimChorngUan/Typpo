...
var typingAudio = new Audio(
  '../audio/office_keyboard_apple_key_press_single.mp3'
);

var iceAudio = new Audio('../audio/sound_spark_Ice_Spell_Death_Frost_01.mp3');

var fireAudio = new Audio(
  '../audio/sound_spark_Fire_Spell_Torch_Of_Light_03.mp3'
);
...
var quitAudio = new Audio('../audio/quit.mp3');
